...
extension UIColor
{
    ...
    public class func lerp(start:UIColor, end:UIColor, t:CGFloat) -> UIColor {
    ...
    // cosine interpolate
    public class func coserp(start:UIColor, end:UIColor, t:CGFloat) -> UIColor {
        let srgba = start.components
        let ergba = end.components
    ...
    public class func eerp(start:UIColor, end:UIColor, t:CGFloat) -> UIColor {
        let srgba = start.components
        let ergba = end.components
    ...
    public class func bilerp(start:[UIColor], end:[UIColor], t:[CGFloat]) -> UIColor
    {
